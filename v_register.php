...
<body>
    ...
    <div class="container">
        ...
        <form id="loginForm" action="v_register_process.php" method="POST">
        <div class="input-group">
            ...
            <a href="v_login.php" class="btn">I Already have account</a>

            <button id="btnLogin" type="submit">Sumbit</button>
        </form>
    </div>
